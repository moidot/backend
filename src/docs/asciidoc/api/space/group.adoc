...
include::{snippets}/detail-recommended/http-request.adoc[]
include::{snippets}/detail-recommended/path-parameters.adoc[]

==== HTTP Response Body

include::{snippets}/detail-recommended/http-response.adoc[]
include::{snippets}/detail-recommended/response-fields.adoc[]